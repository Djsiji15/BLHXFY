...
(function () {
  ...
  var getLocalConfig = function getLocalConfig() {
    ...
    var keys = ['autoDownload', 'bottomToolbar', 'displayName', 'removeScroller', 'hideSidebar', 'originText', 'storyOnly', 'transJa', 'transEn', 'keepBgm', 'font', 'transApi', 'fontBold', 'plainText', 'battleTrans', 'log', 'defaultFont'];
  ...
  */
  ...
  var transStart = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(data, pathname) {
      var pathRst, sNameTemp, rst, scenarioName, _yield$getScenario, transMap, csv, nameData, nameMap, _yield$getNounData, nounMap, nounFixMap, caiyunPrefixMap, _collectTxt, txtList, infoList, startIndex, transList, transNotice, transApiName, apiData;
